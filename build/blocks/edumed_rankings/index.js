...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@apollo/client'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
 // Import Apollo Client and InMemoryCache from Apollo Client package

const client = new Object(function webpackMissingModule() { var e = new Error("Cannot find module '@apollo/client'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
  uri: '/graphql',
  // Set the URI for the GraphQL endpoint. Replace with the correct endpoint URI for your server
  cache: new Object(function webpackMissingModule() { var e = new Error("Cannot find module '@apollo/client'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())() // Initialize a new in-memory cache to store query results and manage cache normalization
});
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@apollo/client'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _apolloClient__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./apolloClient */ "./src/blocks/edumed_rankings/apolloClient.js");
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editor.scss */ "./src/blocks/edumed_rankings/editor.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./block.json */ "./src/blocks/edumed_rankings/block.json");
...
function Edit({
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)(); // Get the block props that apply necessary class names and attributes

  return (
    // Wrap the block content with ApolloProvider to give access to Apollo Client throughout the component tree
    (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@apollo/client'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
      client: _apolloClient__WEBPACK_IMPORTED_MODULE_2__.client
      ...
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Rankings Settings', _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      initialOpen: true
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.SelectControl, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Post Type', _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      value: postType,
      options: [{
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Program', _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      value: program,
      onChange: value => setAttributes({
        program: value
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Default Open', _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      value: defaultOpen,
      onChange: value => setAttributes({
        defaultOpen: value
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Has 2 and 4 Years?', _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Default Level Year', _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Version', _block_json__WEBPACK_IMPORTED_MODULE_7__.textdomain),
      value: version,
      options: [{
        label: 'Choose an option',
        value: ''
