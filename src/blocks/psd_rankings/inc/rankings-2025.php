<?php
/**
 * PSD Rankings - 2025 Render
 *
 * Partial template for the "Rankings 2025" design.
 * This file contains all the rendering logic for the 2025 version of the PSD rankings block.
 */

/**
 * Renders the PSD Rankings block using the 2025 design.
 *
 * @param array $attributes The block attributes.
 * @return string The block HTML content.
 */
function psd_render_block_rankings_2025( $attributes ) {
 ...
 * @param int   $order The menu order (rank).
...
/**
 * Renders the ACF fields list for a rankings item.
 *
 * @param array $acf_fields The ACF fields array.
