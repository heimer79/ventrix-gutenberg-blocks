...
?>
<div class="<?php echo $current_site; ?>-salaries-careers-table-mobile salaries-careers-table-mobile cafeto-salaries-careers-table-mobile is-template-career-double-row-table-mobile" id="<?php echo esc_attr($block_id); ?>">
    <?php if ($show_title): ?>
